...
\homepage{http://nicolasgutehrle.com}{http://nicolasgutehrle.com} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\cventry{September 2018 -- March 2019}{Research ingineer in "\textit{ORTEP Revitalisation}" project}{Université de Franche-Comté}{Besançon, France}{MSHE C.N. Ledoux}{
\begin{itemize}
